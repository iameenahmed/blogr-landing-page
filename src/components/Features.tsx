...
const Features = () => {
  return (
    <div className="mx-auto my-16 max-w-[30rem] text-center text-VeryDarkBlue lg:my-64 lg:-ml-[7.25vw] lg:grid lg:max-w-full lg:grid-cols-2 lg:text-start xl:mr-[11.25vw] xl:gap-32">
      <picture className="scale-[1.54]">
      ...
      <div className="px-8 lg:pl-[5.25rem]">
        <div className="my-12">
          ...
          <p className="tracking-wide text-VeryDarkGrayishBlue lg:leading-[1.75]">
